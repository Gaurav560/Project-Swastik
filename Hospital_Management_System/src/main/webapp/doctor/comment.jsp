		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				...
				<div class="card paint-card">
					...
					<!-- agar comment succesfully add ho gaya to sucMsg wala if test pass ho
					 jaayega aur uska value print ho jaayega warna failMsg wala print ho ga . -->
					...
					<div class="card-body">
						...
						<!--aplicant Dynamic values inserted in the comment card for doctor  -->
						<%
						...
						<form class="row" action="../updateServlet" method="post">
							...
							<input type="hidden" name="aid" value="<%=ap.getId()%>">
